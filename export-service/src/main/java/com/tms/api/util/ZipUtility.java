...
public class ZipUtility {
    ...
    public void zip(File dir, String destZipFile) throws FileNotFoundException,
            IOException {
        ZipOutputStream zos = new ZipOutputStream(new FileOutputStream(destZipFile));
...
//    public ZipOutputStream zip(File dir, String destZipFile) throws FileNotFoundException,
//            IOException {
//        ZipOutputStream zos = new ZipOutputStream(new FileOutputStream(destZipFile));
//
//        zipDirectory(dir, dir.getName(), zos);
